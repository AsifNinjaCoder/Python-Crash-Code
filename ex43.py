...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            and your last mission is to get the neutron destruct bomb the 
            from the Weapons Armory, put it in the bridge, and blow the ship up 
            after getting into an escape pod.
            You're running down the central corridor to the Weapons
            Armory when a Ghoton jumps out, red scaly skin, dark grimy teeth, 
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                ...
                your foot slip and you bang your head on the metal 
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print(dedent("""
                ...
                Gothons below up the ship from their ship and you die.
            """))
            return 'death'
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                ...
                blaster at it. You then jump through the door, 
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            escape pods, and now need to pcik one to take. Some of 
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                ...
                bright star, takig out the Gothon ship at the same 
                time. You won!
            """))
            return 'finished'
